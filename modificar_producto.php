...
if(isset($enviar)){
    ...
    $mysqli->query("UPDATE productos SET names='$names',descripcion='$descripcion',price='$price',id_categoria='$categoria' WHERE id='$idpro'");
...
<form method="post"action="" enctype="multipart/form-data">
    ...
    <div class="form-group">
    <input class="form-control" type="text" name="descripcion" value="<?=$rq['descripcion']?>"placeholder="Descripcion del Producto">
    </div>
